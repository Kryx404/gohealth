    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Medical devices", path: "/", icon: null },
                { text: "Medical device", path: "/", icon: null },
                { text: "AIDS", path: "/", icon: null },
                { text: "Vitamin", path: "/", icon: null },
                { text: "Supplement", path: "/", icon: null },
            ],
        },
        {
            title: "WEBSITE?",
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+62-8212-456-7890", path: "/", icon: PhoneIcon },
                { text: "gohealth@gmail.com", path: "/", icon: MailIcon },
                {
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">
                            Welcome to gohealth, Your trusted destination for
                            genuine health and wellness products. From
                            supplements to medical devices, we help you stay
                            healthy with products that care. — all in one place.
                        </p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © gohealth All Right Reserved.
                </p>
            </div>
        </footer>
    );
